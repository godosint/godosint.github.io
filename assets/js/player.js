...
const defaultFooterText = "〤 praising shiku 〤";

const tracks = [
  {
    title: "Nardo Wick - Excuse My French",
    path: "assets/music/ExcuseMyFrench.mp3",
  },
  { title: "Yeat - On tha line", path: "assets/music/OnThaLine.mp3" },
  {
    title: "Biggie Smalls - Foe The Love Of Money",
